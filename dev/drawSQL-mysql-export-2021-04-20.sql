...
ALTER TABLE
    `request_motive` ADD  `request_motive_id_primary`(`id`);
...
ALTER TABLE
    `request_status_history` ADD  `request_status_history_id_primary`(`id`);
...
ALTER TABLE
    `request_history` ADD  `request_history_id_primary`(`id`);
...
ALTER TABLE
    `request` ADD  `request_id_primary`(`id`);
ALTER TABLE
...
ALTER TABLE
    `menu_type` ADD  `menu_type_id_primary`(`id`);
...
ALTER TABLE
    `menu_profile` ADD  `menu_profile_id_primary`(`id`);
...
ALTER TABLE
    `profile` ADD  `profile_id_primary`(`id`);
CREATE TABLE `user_status`(
    `id` INT UNSIGNED NOT NULL PRIMARY KEY AUTO_INCREMENT,
    `description` VARCHAR(255) NOT NULL
);
ALTER TABLE
    `user_status` ADD  `user_status_id_primary`(`id`);
...
ALTER TABLE
    `persona` ADD  `persona_id_primary`(`id`);
CREATE TABLE `status`(
    `id` INT UNSIGNED NOT NULL PRIMARY KEY AUTO_INCREMENT,
    `description` VARCHAR(255) NOT NULL
);
ALTER TABLE
    `status` ADD  `status_id_primary`(`id`);
CREATE TABLE `document_type`(
    `id` INT UNSIGNED NOT NULL PRIMARY KEY AUTO_INCREMENT,
    `description` VARCHAR(255) NOT NULL
);
ALTER TABLE
    `document_type` ADD  `document_type_id_primary`(`id`);
ALTER TABLE
...
ALTER TABLE
    `log` ADD  `log_id_primary`(`id`);
CREATE TABLE `request_status`(
    `id` INT UNSIGNED NOT NULL PRIMARY KEY AUTO_INCREMENT,
    `description` VARCHAR(255) NOT NULL
);
ALTER TABLE
    `request_status` ADD  `request_status_id_primary`(`id`);
ALTER TABLE
